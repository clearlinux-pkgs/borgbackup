...
pushd ..
cp -a borgbackup-1.1.17 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666741379
...
cp %{_builddir}/borgbackup-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/borgbackup/87cb76efc3c2fc3582eb2ed5f760f354aefbc43a || :
cp %{_builddir}/borgbackup-%{version}/docs/3rd_party/blake2/COPYING %{buildroot}/usr/share/package-licenses/borgbackup/d32fa0b0c2b059b3fd4d2a317d0cf1cd0da791d4 || :
...
cp %{_builddir}/borgbackup-%{version}/docs/3rd_party/msgpack/COPYING %{buildroot}/usr/share/package-licenses/borgbackup/175e59be229a5bedc6be93e958a970385bb04a62 || :
